# data_frame: table with raw data, album_string: name of the album, artist_string: name of the artist, 
# exact_search_bool = TRUE if the album name should be matched exactly
...
top_album_tracks <- function(data_frame, album_string, artist_string, exact_search_bool = FALSE){
  data_frame <- subset(data_frame, ms_played > 30000) # Filter out streams shorter than 30s; Spotify counts a stream after 30s
